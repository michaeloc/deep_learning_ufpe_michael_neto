...
path = "arquivos_experimentos/*.csv"
    ...
    with open(file, encoding="utf8") as f:
        ...
        for line in reader:
            if (line[1] != 'entity'):
                ...
                #     (label_target in unique_class_downloaded2) or \
                #     (label_target in unique_class_downloaded3) or \
                #     (label_target in unique_class_downloaded4):
                #     print('ja baixou')
                #     print(label_target) 
                #     break
                print(label_target.encode('utf-8'))
...
#               consulta para recuperar o resumo
                ...
                try:
                    ...
                    if(reader.line_num % 10 == 0):
                        ...
                        data_frame.to_csv('file_output_differences.csv')
                        dataset = []
                    ...
                    if err.code == 404:
                        ...
                        df.to_csv('file_output_differences.csv')
                    else:
                        raise
